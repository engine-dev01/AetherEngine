// payload_store.hpp — 92 encrypted payloads (DATA_DUMP(transcript สูญ-UNVERIFIED) §4)
...
// ถอด payload โดยใช้ jkl_key (DATA_DUMP(transcript สูญ-UNVERIFIED) §4.3) + KeyStore::deriveKey (per-name XOR)
